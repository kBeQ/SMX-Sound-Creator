...
class SettingsFrame(ttk.Frame):
    ...
    def build_ui(self):
        ...
        lib_frame = ttk.Labelframe(scrollable_frame, text="Local Mod Library", padding=15)
        lib_frame.pack(fill='x', expand=True, pady=(0, 20))
        ttk.Label(lib_frame, text="Configure folders on your PC that contain your mod categories.").pack(anchor='w')
        ...
        for path in self.controller.library_paths:
    ...
    def add_library_folder(self):
        folder = filedialog.askdirectory(title="Select a folder containing mod categories")
